...
See the file LICENCE for full license details.
    ...
    Settings viewer of the SumoExampleV2 plugin
"""

from qtpy import QtWidgets

from ExampleModulesPackage.SumoExampleV2.Ui_SumoExampleV2SettingsView import Ui_SumoExampleV2SettingsView
from commons.BaseSettingsView import BaseSettingsView

class SumoExampleV2SettingsView(BaseSettingsView, Ui_SumoExampleV2SettingsView, QtWidgets.QWidget):
    """
        SumoExampleV2View set the SumoExampleV2 settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to SumoExampleV2
